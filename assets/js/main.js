...
var loader = function() {
    ...
    $("#tech-and-web--overlayer").delay(200).fadeOut("slow");
}
...
var siteMenuClone = function() {
    ...
    setTimeout(function() {
        ...
        var counter = 0;
        $('.tech-and-web--site-mobile-menu .has-children').each(function() {
            var $this = $(this);
...
var mobileToggleClick = function() {
    ...
    $(document).mouseup(function(e) {
        var container = $(".tech-and-web--site-mobile-menu");
...
var onePageNavigation = function() {
    ...
    $("body").on("click", ".tech-and-web--site-nav .site-nav-ul li a[href^='#'], .smoothscroll[href^='#'], .tech-and-web--site-mobile-menu .site-nav-wrap li a[href^='#']", function(e) {
    ...
    $.ajax({
        ...
        success: function(html) {
            ...
            pSingleHolder.append(
                ...
                '" class="portfolio-single-inner"><span class="tech-and-web--close-portfolio js-close-portfolio d-flex align-items-center"><span class="close-portfolio-label">Back to Portfolio</span><span class="icon-close2 wrap-icon-close"></span></span>' + getHTMLContent + '</div>'
            );
...
var jarallaxPlugin = function() {
    ...
    jarallax(document.querySelectorAll('.jarallax-video'), {
        speed: 0.2,
        videoSrc: 'https://youtu.be/SFxNnXjBFhI',
        videoStartTime: 0,
        videoEndTime: 18,
    });
};
        ...
        $("#contactForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        $('#form-message-warning').html("Problème de connexion. Veuillez nous joindre par appel svp.");
                        $('#form-message-warning').fadeIn();
                        $submit.css('display', 'none');
                    }
                });
...
var stickyFillPlugin = function() {
    var elements = document.querySelectorAll('.tech-and-web--sticky');
